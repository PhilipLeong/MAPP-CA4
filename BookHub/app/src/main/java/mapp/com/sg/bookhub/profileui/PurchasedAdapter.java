...
public class PurchasedAdapter extends RecyclerView.Adapter<PurchasedAdapter.ViewHolder> implements View.OnClickListener{

    private List<Post> postItems;
    private Context context;
    private static DecimalFormat df2 = new DecimalFormat("##.00");

    public PurchasedAdapter(List<Post> posts, Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.profilepurchased_cardview, parent, false);
